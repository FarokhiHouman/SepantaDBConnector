...
public partial class FrmConnection : Form {
    ...
    private void btnTestConnection_Click(object sender, EventArgs e) {
        ...
        using SqlConnection sqlConnection =
            new(connectionString: _connectionStringBuilder.ConnectionString);
        try {
            sqlConnection.Open();
    ...
    private void btnSaveConnection_Click(object sender, EventArgs e) {
        try {
            ...
            MessageBox.Show(text: Resources.ConnectionNotSaved,
                            caption: Resources.SepantaConnection, buttons: MessageBoxButtons.OK,
